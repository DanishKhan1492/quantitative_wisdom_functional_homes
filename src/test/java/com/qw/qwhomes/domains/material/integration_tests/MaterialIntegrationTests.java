...
public class MaterialIntegrationTests {
    ...
    void shouldGetMaterialById() throws Exception {
        mockMvc.perform(get("/api/v1/materials/{id}", testMaterial.getId()))
                .andExpect(status().isOk())
    ...
    void shouldUpdateMaterial() throws Exception {
        ...
        mockMvc.perform(put("/api/v1/materials/{id}", testMaterial.getId())
                .contentType(MediaType.APPLICATION_JSON)
    ...
    void shouldDeleteMaterial() throws Exception {
        mockMvc.perform(delete("/api/v1/materials/{id}", testMaterial.getId()))
